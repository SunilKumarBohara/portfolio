...
import { FolderTree, Plus, Trash2, Edit, Save, Loader2, Sparkles, Folder } from "lucide-react";
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        error(err.error || "Failed to save category");
      }
    } catch (err) {
      error("Network error");
    } finally {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-gray-400 font-mono mt-0.5">
          Organize blog articles by topical SEO themes and pillar content areas
        </p>
      </div>
