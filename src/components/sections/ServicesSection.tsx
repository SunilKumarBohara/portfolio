...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="relative py-24 sm:py-32 bg-background border-t border-white/5 overflow-hidden">
      ...
      <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-brand-green/5 blur-[150px] pointer-events-none" />
            ...
            return (
              <ScrollReveal key={service.id} animation="fade-up" delay={index * 0.06}>
                <GlassCard
                  ...
                  className="h-full flex flex-col justify-between p-6 border-white/10 hover:border-brand-green/50 cursor-pointer group"
                >
                  <div>
                    {/* Top Icon & Index */}
                    ...
                    <h3 className="text-lg font-bold text-white group-hover:text-brand-green transition-colors mb-1 font-display">
                      {service.title}
                    </h3>
                  ...
                  <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between text-xs font-mono text-gray-300 group-hover:text-brand-green transition-colors">
        ...
        {selectedService && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-xl">
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-surface-300 border border-brand-green/40 rounded-3xl p-6 sm:p-8 shadow-2xl overflow-hidden"
            >
              {/* Close Button */}
              <button
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="p-2.5 rounded-xl bg-brand-green/10 border border-brand-green/30 text-brand-green">
              ...
              <div className="space-y-3 mb-6">
                <h4 className="text-xs font-mono uppercase tracking-wider text-brand-green">
              ...
              {/* Business Impact */}
              <div className="p-4 rounded-xl bg-brand-green/5 border border-brand-green/20 text-xs text-gray-300">
                <strong className="text-brand-green block mb-1 font-mono">
