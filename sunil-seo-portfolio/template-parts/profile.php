<?php
/**
 * Template part for Profile Showcase Section
 *
...
$profile_image = get_theme_mod('skb_profile_image', '');
$profile_name  = get_theme_mod('skb_hero_title', 'Sunil Kumar Bohara');
$profile_role  = get_theme_mod('skb_hero_subtitle', 'SEO Executive · Nepal');
$profile_bio   = get_theme_mod(
    'skb_profile_bio',
    'SEO Executive focused on search visibility, keyword research, content optimization, technical SEO and the evolving search landscape.'
);
...
<section id="profile" class="profile-section">
    <div class="container">
        <div class="profile-card">
            <!-- Circular Profile Photo with Blue-to-Red Gradient Halo -->
            ...
            <!-- Identity Meta -->
            <h2 class="profile-name"><?php echo esc_html($profile_name); ?></h2>
            <p class="profile-role-tag"><?php echo esc_html($profile_role); ?></p>
            <p class="profile-bio">
                &ldquo;<?php echo esc_html($profile_bio); ?>&rdquo;
            </p>

            <!-- Focus Pills -->
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 8px; margin-bottom: 24px;">
                <span class="badge" style="box-shadow: none; font-size: 0.72rem;">Technical SEO</span>
                <span class="badge" style="box-shadow: none; font-size: 0.72rem;">Keyword Strategy</span>
                <span class="badge" style="box-shadow: none; font-size: 0.72rem;">Core Web Vitals</span>
                <span class="badge" style="box-shadow: none; font-size: 0.72rem;">Content Architecture</span>
                <span class="badge" style="box-shadow: none; font-size: 0.72rem;">White-Hat SEO</span>
            </div>
